...
# display property sidebar
property_menu()

# display titles
st.title("Real Estate Management System")

# button to reset the view and select another property
if st.button('Refresh Properties'):
    st.session_state['property_data'] = None
    st.session_state['view_property'] = False

# display and handle the first form if no property is currently being viewed/edited
...
# display the property form if a property has been selected
